...
class AtCoderTask:
    def __init__(self, url: str, name: Optional[str],  ses: Optional[Session] = None, contest:Optional['ContestBase']=None):
        self.url = url
...
class AtCoderContest(ContestBase):
    ...
    def get_tasks(self) -> Generator[AtCoderTask, None, None]:
        ...
        for tr in soup.select('tbody tr'):
            ...
            yield AtCoderTask(task_url, task_name, self.ses)
...
class VirtualContest(ContestBase):
    ...
    def get_tasks(self) -> Generator[AtCoderTask, None, None]:
        ...
        for i, p in enumerate(self.data['problems'], start=1):
            ...
            yield AtCoderTask(task_url, f'{i:02}', self.ses)
